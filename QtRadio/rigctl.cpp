...
void RigCtlSocket::readyRead()
{
    ...
    { // get_freq
        ...
        if (cmdlist[0].compare("F") == 0 && cmdlistcnt == 2)
        { // set_freq
                    ...
                    { // set_VFO
                        ...
                        { // get_rit
                            ...
                            { // get_split_vfo
                                ...
                                if (command[0] == 'T')
                                { // set_ptt  no tx yet but this keeps grig and fldigi happy
                                    ...
                                    { // quit
                                        ...
                                        if (cmdlist[0].compare("M") == 0 && cmdlistcnt == 3)
                                        {
                                            if (cmdlist[1].compare("USB") == 0 )
                                            {
                                                ...
                                                if (cmdlist[2].compare("5000") == 0 )
                                                {
                                                    ...
                                                    if (cmdlist[2].compare("4400") == 0 )
                                                    {
                                                        main->rigctlSetFilter(1);
                                                    }
                                                    else
                                                        if (cmdlist[2].compare("3800") == 0 )
                                                        {
                                                            main->rigctlSetFilter(2);
                                                        }
                                                        else
                                                            if (cmdlist[2].compare("3300") == 0 )
                                                            {
                                                                main->rigctlSetFilter(3);
                                                            }
                                                            else
                                                                if (cmdlist[2].compare("2900") == 0 )
                                                                {
                                                                    main->rigctlSetFilter(4);
                                                                }
                                                                else
                                                                    if (cmdlist[2].compare("2700") == 0 )
                                                                    {
                                                                        main->rigctlSetFilter(5);
                                                                    }
                                                                    else
                                                                        if (cmdlist[2].compare("2400") == 0 )
                                                                        {
                                                                            main->rigctlSetFilter(6);
                                                                        }
                                                                        else
                                                                            if (cmdlist[2].compare("2100") == 0 )
                                                                            {
                                                                                main->rigctlSetFilter(7);
                                                                            }
                                                                            else
                                                                                if (cmdlist[2].compare("1800") == 0 )
                                                                                {
